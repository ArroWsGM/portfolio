...
//Settings page & settings managment
    ...
    public function addSettings(Request $request)
    {
		...
		if(Setting::create($request->all()))
    		$request->session()->flash('msg_success', 'Setting successfully added');
    ...
    public function removeSettings(Request $request, Setting $setting)
    {
    	if(Auth::check()){
    		...
    		$request->session()->flash('msg_success', 'Setting named "' . $setting->setting_name . '" was removed');
    	}
...
//Users managment
    public function users()
    {
		...
		$page_title = 'Users';
    	return view('admin.users', array(	'page_title' => $page_title,
    ...
    public function removeUsers(Request $request, User $user)
    {
    	if(Auth::check()){
    		...
    		$request->session()->flash('msg_success', 'Setting named "' . $user->name . '" was removed');
    	}
    ...
    public function addUsers(Request $request)
    {
		...
		if(User::create([
    		...
    		$request->session()->flash('msg_success', 'User successfully added');
